<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Tambah Detail Penjualan Produk Baru') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('detail_penjualan_produk.store') }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="jumlah_terjual" class="block mt-1 w-full" type="number" name="jumlah_terjual" :value="old('jumlah_terjual')" required min="1" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="subtotal_pendapatan" class="block mt-1 w-full" type="number" step="0.01" name="subtotal_pendapatan" :value="old('subtotal_pendapatan')" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="subtotal_keuntungan" class="block mt-1 w-full" type="number" step="0.01" name="subtotal_keuntungan" :value="old('subtotal_keuntungan')" required />
